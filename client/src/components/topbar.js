  ...
  return (
    <>
      ...
      <div className="fixed flex items-center border-b border-main-border bg-main-800 w-[calc(100%-65px)] right-0 z-10 top-0 min-h-[65px] max-h-[65px] px-5">
        ...
        <button
          className="ml-5 px-4 min-h-[38px] max-h-[38px] whitespace-nowrap text-sm text-white/70 border rounded-md bg-main-900 border-main-border "
        ...
        <div className="ml-auto">
          {user && (
            <aside className="flex items-center gap-5 ml-auto">
              ...
              />
              <span className="h-[38px] w-[38px] bg-main-900 border-main-border border rounded-full flex items-center justify-center">
