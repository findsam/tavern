  ...
  return (
    <>
      ...
      <Dropdown show={profile} setShow={setProfile}>
        ...
        <ul className="text-sm border-t text-white/70 border-main-border border-b py-3.5 gap-1.5 grid">
          <li className="leading-5 duration-150 hover:cursor-pointer hover:text-white px-3.5">
            Account Settings
          </li>
          <li className="leading-5 duration-150 hover:cursor-pointer hover:text-white  px-3.5">
            Upgrade Account
