...
export const Dropdown = ({ show, setShow, children }) => {
  ...
  return (
    <div
      className="absolute z-50 flex w-full max-w-[252px] min-w-max left-1/2 -translate-x-1/2 top-[calc(100%+16px)] overflow-hidden transition-all duration-75 drop-shadow-3xl"
      ref={container}
    >
