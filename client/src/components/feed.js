  ...
  return (
    <div className="relative w-full overflow-hidden">
      <div className="w-full">
        ...
        <div className="flex flex-col items-start w-full mt-1.5 text-white">
          <ul className="flex gap-1.5 font-normal leading-none tracking-wide">
            <li className="px-2 py-1 text-xs tracking-wide text-white duration-150 rounded-full bg-main-800">
              #photoshop
            </li>
            <li className="px-2 py-1 text-xs tracking-wide text-white duration-150 rounded-full bg-main-800">
              #warcraft
          ...
          <div className="flex items-center gap-2 mt-1.5">
            ...
            <span className="text-xs tracking-wide text-left">
              <a>svk#dev</a>
              <p className="text-left opacity-70">World of Warcraft</p>
            </span>
          </div>
        </div>
      </div>
