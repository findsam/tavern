  ...
  return (
    <div className="relative w-full overflow-hidden">
      <div className="w-full">
        <div className="relative h-full max-w-full mx-auto my-0 overflow-hidden rounded-lg drop-shadow-md">
        ...
        <div className="flex items-center w-full gap-3 mt-2 text-white">
          ...
          <ul className="flex gap-2 text-[10px] font-normal tracking-wide leading-none">
            <li className="px-2 py-1 text-xs tracking-wide text-white duration-150 rounded-md bg-main-800">
              #photoshop
            </li>
            <li className="px-2 py-1 text-xs tracking-wide text-white duration-150 rounded-md bg-main-800">
              #warcraft
