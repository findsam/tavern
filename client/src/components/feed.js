...
const Post = ({ post }) => {
  return (
    <div className="relative w-full overflow-hidden border rounded-lg bg-main-800 border-main-700 drop-shadow-md">
      <div className="w-full bg-main-800">
        ...
        <div className="flex items-center w-full gap-3 py-1.5 px-2 text-white absolute bottom-0">
          {/* <Image
