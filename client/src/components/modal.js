        ...
        <div className="duration-300 -translate-y-8 border rounded-lg opacity-0 border-main-border bg-main-800 main">
          <div className="max-w-[550px] w-full min-w-[550px] pb-5 relative">
            ...
            <div className="flex items-center border-b border-main-border">
              <ul className="flex h-full gap-5 px-7">
                <li className="py-7  flex text-sm gap-1.5 after:absolute after:content-[''] after:bottom-[-1px] after:h-[2px] after:block after:bg-green-900 relative after:w-full">
                ...
                <li className="py-7  flex text-sm gap-1.5 after:absolute after:content-[''] after:block after:bg-main-border relative after:w-full">
