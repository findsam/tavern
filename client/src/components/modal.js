    ...
    <li className="flex gap-3.5 p-5 border-b border-main-border">
      ...
      <div className="grid gap-1.5">
        ...
        <div className="flex gap-2.5 mt-0.5">
          <button className="px-1.5 min-h-[30px] text-sm  border border-green-900 rounded-md text-green-400 bg-green-900/40 duration-150 hover:bg-green-900">
            Approve
          </button>
          <button className="px-1.5 min-h-[30px] text-sm text-white/70 border rounded-md bg-main-700 border-main-border  hover:bg-main-900 hover:text-white duration-150">
            Deny
          </button>
        </div>
      </div>
