  ...
  return (
    <>
      ...
      <main className="relative z-0 flex flex-col items-center max-w-2xl gap-5 mx-auto mt-48 text-center">
        ...
        <a
          href={getDiscordURL()}
          className="relative max-w-max flex-1 px-6 min-h-[38px] gap-2 text-sm text-main-text/70 border rounded-md bg-main-800 border-main-border  hover:border-white/70  duration-150 flex items-center justify-center"
        >
      ...
      <section className="relative my-36 -z-10 ">
        <div className="max-w-6xl mx-auto blur-[0.01rem] relative ">
          ...
          />
          <img
            src="/icons/check_the_platform.svg"
